const METRICS = {
  ...
  cpm:             { label: 'CPM',            format: 'currency',    hasRating: true,  inverted: true,  thresholds: { green: 15.0, yellow: 25.0 }, benchmark: '~$8–$15 avg', description: 'Cost per 1,000 Impressions — how much it costs to reach 1,000 people.', context: 'High CPM can mean competitive audience or narrow targeting.' },
  ...
  conversion_rate: { label: 'Conv. Rate',     format: 'percent',     hasRating: true,  inverted: false, thresholds: { green: 4.0, yellow: 2.0 },  benchmark: '~2.9% Google / ~9.2% Meta', description: '% of clicks that resulted in a conversion.', context: 'Higher = better landing page and audience-offer match.' },
  ...
  roas:            { label: 'ROAS',           format: 'multiplier',  hasRating: true,  inverted: false, thresholds: { excellent: 2.0, green: 1.5, yellow: 0.5 }, benchmark: '1.5x+ good / 2x+ excellent', description: 'Return on Ad Spend — revenue per $1 of ad spend.', context: '2x+ is excellent. 1.5x is good. Below 0.5x = spend needs review.' },
